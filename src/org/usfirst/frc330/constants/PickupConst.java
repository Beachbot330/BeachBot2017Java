...
public class PickupConst {
	...
	public static final double HOPPER_SHOOT_INTERVAL 		= 1.5;		// JR 3-15 pulse interval in seconds
	public static final double HOPPER_SHOOT_DURATION 		= 0.5;		// JR 3-15 pulse duration in seconds
}
