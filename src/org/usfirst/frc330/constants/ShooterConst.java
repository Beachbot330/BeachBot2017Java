...
public class ShooterConst {
	...
	public static final TalonPIDSettings LB_KPA 		= new TalonPIDSettings(0.25,  0.0,  0.0,  0.005, 100.0,    3550,  100.0,  0.9555);	//AP 4-21
	...
	public static final TalonPIDSettings DEFAULT        = RB_KPA;
