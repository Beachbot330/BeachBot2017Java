...
public class ShooterConst {
	...
	public static final TalonPIDSettings CLOSE 			= new TalonPIDSettings(0.2,  0.0,  0.0,  0.0045, 100.0,    3700,  100.0,  0.97);   // AP 3-10
	public static final TalonPIDSettings FAR 		    = new TalonPIDSettings(0.2,  0.0,  0.0,  0.0045, 100.0,    500,   100.0,  0.90);   //WAG
