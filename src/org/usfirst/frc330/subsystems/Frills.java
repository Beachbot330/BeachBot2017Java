...
public class Frills extends Subsystem {
    ...
    private final DigitalOutput dyingGreenSuns = RobotMap.frillsDyingGreenSuns;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    
    private final UsbCamera driverCam = RobotMap.frillsDriverCam;
    private final UsbCamera shooterCam = RobotMap.frillsShooterCam;
    ...
    public void igniteDyingSun(){
    	dyingGreenSuns.set(true);
    }
    
    public void extinguishDyingSun(){
    	dyingGreenSuns.set(false);
    }
