 ...
 *
 */
public class NotLeftBoilerGearShoot extends BBCommandGroup {

    public NotLeftBoilerGearShoot() {
        // Add Commands here:
    	...
    	addSequential(new DriveWaypoint(0, 108, 3, 4, true, ChassisConst.DriveHigh, ChassisConst.GyroDriveHigh )); //drive forward before turn
    	addSequential(new WaitCommand(2));
