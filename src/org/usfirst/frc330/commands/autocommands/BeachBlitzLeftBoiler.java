 ...
 *
 */
public class BeachBlitzLeftBoiler extends BBCommandGroup {
	
	double distance = 88; // Original distance 88
	double straight = 5; // Original distance 5
    ...
    public BeachBlitzLeftBoiler() {
    	...
    	addSequential(new DriveWaypointBackward(0, -straight-10, 10, 4.0, true, ChassisConst.DriveLow, SecretSauce1));
    	addSequential(new DriveWaypointBackward(-Math.cos(Math.toRadians(57))*distance, -Math.sin(Math.toRadians(57))*distance-straight, 5, 3.5, true, ChassisConst.DriveLow, SecretSauce2));
