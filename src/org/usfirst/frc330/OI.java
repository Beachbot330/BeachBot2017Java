...
public class OI {
    ...
    public JoystickButton shoot_L1_rel;
    ...
    public JoystickButton shoot_R1_rel;
    ...
    public OI() {
        ...
        shoot_R1_rel = new JoystickButton(driverR, 1);
        shoot_R1_rel.whenReleased(new GateReverse());
        shoot_R1 = new JoystickButton(driverR, 1);
        shoot_R1.whenPressed(new GateOn());
        ...
        shoot_L1_rel = new JoystickButton(driverL, 1);
        shoot_L1_rel.whenReleased(new GateReverse());
        shoot_L1 = new JoystickButton(driverL, 1);
        shoot_L1.whenPressed(new GateOn());
        ...
        SmartDashboard.putData("HoodAngle", new HoodAngle());
