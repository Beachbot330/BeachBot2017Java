...
public class OI {
    ...
    public JoystickButton pickupGear_3held;
    ...
    public OI() {
        ...
        pickupGear_3held = new JoystickButton(operator, 1);
        pickupGear_3held.whileHeld(new PickupGear());
        ...
        releaseGear_R5.whenPressed(new GearRelease());
        releaseGear_R4 = new JoystickButton(driverR, 4);
        releaseGear_R4.whenPressed(new GearRelease());
        ...
        releaseGear_L5.whenPressed(new GearRelease());
        releaseGear_L4 = new JoystickButton(driverL, 4);
        releaseGear_L4.whenPressed(new GearRelease());
